<?php
	if(isset($_POST['submit']))
	{
		...
		$sql="INSERT INTO bhms_table(Clg_Logo, Clg_Name, Phone_No, Stud_Image, Stud_Name, DOB, Year, Address, Mobile_No)
		...
		header('refresh:0;bhms_display.php');
		$conn->close();
...
<html>
<head>
	<title> BHMS Student Detail Form </title>
<style>
	...
	<font color="white">
		<form>
		<input type="submit"  value="||Back||" formaction="stream.php" style="background-color:gray; color:black; font-size:20px; font-family:Elephant;">
...
<center>
	<div>
		...
		<hr>
		<font color="lightgray"><h1> <b><i><u>BHMS Student details form </b></i></u></h1></font>
		<hr />		
