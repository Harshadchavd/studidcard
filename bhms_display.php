...
<html>
<head>
	<title>BHMS Student Data Display...</title>
</head>
<body bgcolor="gray">
<center>
<font color="black "><h1><u><b>BHMS Student Data</b></u></h1></font></center>
...
<hr>
		...
		<input type="submit"  value="||Home||" formaction="home.php" style="background-color:black; color:white; font-size:20px; font-family:Elephant;"><hr /> 
		</form>
<center>
...
<?php
$conn->query("select * from bhms_table");
while($row = mysqli_fetch_array($result,MYSQLI_BOTH))
{	
?>
<tr>
	<td><?php echo $row['No'];?></td> <td> <img src="upload/<?php echo $row['Clg_Logo'];?>" height="50" width="80"> </td> <td><?php echo $row['Clg_Name']; ?></td>
	...
	<h1><center><a href="bhms_form.php">Add More Records....</a></h1>
</body>
</html>
