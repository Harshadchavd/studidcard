<?php
	if(isset($_POST['submit']))
	{
		...
		mysql_select_db('stud_details') or die("no database found");
		mysql_query("insert into clg_table1(Clg_Logo, Clg_Name, Phone_No, Stud_Image, Stud_Name, DOB, Year, Address, Mobile_No)
